...
FROM docker.io/library/maven:3.9.12-eclipse-temurin-17-alpine@sha256:d50b6f8862731c9b7386bfd35a766613df46d09042ac6eb537f446d8e0e4d534 AS ggj-build

WORKDIR /sdk-platform-java
COPY . .
# {x-version-update-start:gapic-generator-java:current}
ENV DOCKER_GAPIC_GENERATOR_VERSION="2.66.2-SNAPSHOT"
