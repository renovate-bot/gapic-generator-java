...
FROM docker.io/library/maven:3.9.11-eclipse-temurin-17-alpine@sha256:54a722ac05cd45503c18c0033e78a53cc664cab8d81bc6a5b661bb1094a5ce01 AS ggj-build

WORKDIR /sdk-platform-java
COPY . .
# {x-version-update-start:gapic-generator-java:current}
ENV DOCKER_GAPIC_GENERATOR_VERSION="2.61.1-SNAPSHOT"
