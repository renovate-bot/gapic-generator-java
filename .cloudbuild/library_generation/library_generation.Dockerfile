...
FROM docker.io/library/maven:3.9.12-eclipse-temurin-17-alpine@sha256:3ff7466c516a4eeac58c7efabf35549d5d404d8766f131211393ee4a0f366f3b AS ggj-build

WORKDIR /sdk-platform-java
COPY . .
# {x-version-update-start:gapic-generator-java:current}
ENV DOCKER_GAPIC_GENERATOR_VERSION="2.64.3-SNAPSHOT"
