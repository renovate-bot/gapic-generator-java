...
FROM docker.io/library/maven:3.9.12-eclipse-temurin-17-alpine@sha256:bd1dcab89d8d8ccf7583f478d80e1ddd354003e20b7f68f7d6db3860e04b45cf AS ggj-build

WORKDIR /sdk-platform-java
COPY . .
# {x-version-update-start:gapic-generator-java:current}
ENV DOCKER_GAPIC_GENERATOR_VERSION="2.66.1-SNAPSHOT"
